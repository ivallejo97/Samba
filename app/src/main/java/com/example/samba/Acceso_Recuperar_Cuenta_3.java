    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        boton_volver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                navController.navigate(R.id.action_acceso_Recuperar_Cuenta_3_to_acceso_Recuperar_Cuenta_2);
            }
        });
        ...
        boton_confirmar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                navController.navigate(R.id.action_acceso_Recuperar_Cuenta_3_to_acceso_Recuperar_Cuenta_4);
            }
        });
