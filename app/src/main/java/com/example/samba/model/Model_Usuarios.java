...
public class Model_Usuarios implements Serializable {
    ...
    public Model_Usuarios(String email, String name, String pais, String profileImage, String telefono, String uid, String userType, String username, long timestamp) {
        this.email = email;
        this.name = name;
        this.pais = pais;
