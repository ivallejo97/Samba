...
public class Activity_Editar_Camiseta_Usuario extends AppCompatActivity {

    private ActivityEditarCamisetaUsuarioBinding binding;
    private FirebaseAuth firebaseAuth;
    private Uri imageUri = null;
    private String precioCamiseta = "", nombreCamiseta = "", tallaCamiseta = "", marcaCamiseta = "", descripcionCamiseta = "";
    String idCamiseta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((binding = ActivityEditarCamisetaUsuarioBinding.inflate(getLayoutInflater())).getRoot());
        ...
        databaseReference.child(idCamiseta)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (!isDestroyed()){
                            Glide.with(Activity_Editar_Camiseta_Usuario.this).load(foto_camiseta).into(binding.fotoCamiseta);
                        }
    ...
    private void validateData() {
        ...
        tallaCamiseta = binding.tallaCamiseta.getText().toString().trim();
        ...
        if (TextUtils.isEmpty(precioCamiseta)){
            ...
            Toast.makeText(this,"Introduce un nombre",Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(tallaCamiseta)) {
            Toast.makeText(this,"Introduce una talla",Toast.LENGTH_SHORT).show();
    ...
    private void uploadImage(String s) {
        String file = "CamisetasUsuarios/"+firebaseAuth.getUid();
        ...
        storageReference.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Activity_Editar_Camiseta_Usuario.this,"Fallo en la actualización de la imagen", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void actualizarCamiseta(String imageUrl) {
        ...
        hashMap.put("talla",""+tallaCamiseta);
        hashMap.put("descripcion",""+descripcionCamiseta);

        if (imageUri != null){
            hashMap.put("fotoProducto", ""+imageUrl);
        }
        ...
        databaseReference.child(idCamiseta)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(Activity_Editar_Camiseta_Usuario.this,"Camiseta actualizada", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Activity_Editar_Camiseta_Usuario.this,"Fallo al actulizar la camiseta en la DB", Toast.LENGTH_SHORT).show();
                    }
                });
    }
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        Toast.makeText(Activity_Editar_Camiseta_Usuario.this,"Cancelado",Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
